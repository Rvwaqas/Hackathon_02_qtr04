...
import { TaskRefreshProvider, useTaskRefresh, useTaskRefreshListener } from "@/contexts/TaskRefreshContext";
...
function DashboardContent() {
  ...
  // Use the task refresh listener
  useTaskRefreshListener(fetchTasks);
